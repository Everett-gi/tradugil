...
public class ConfiguracaoDeJwt {
    ...
    public ConfiguracaoDeJwt(@Value("${TRADUGIRIA_JWT_SEGREDO:}") String segredo) {
        if (segredo == null || segredo.isBlank()) {
            ...
            this.chave = gerada;
            log.warn("TRADUGIRIA_JWT_SEGREDO não definido: usando chave aleatória desta "
            ...
            if (bytes.length < BYTES_MINIMOS_DA_CHAVE) {
                ...
                throw new IllegalStateException(
                        "TRADUGIRIA_JWT_SEGREDO precisa ter ao menos "
